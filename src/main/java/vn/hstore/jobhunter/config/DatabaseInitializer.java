...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            // Thêm quyền cho các API quản lý ưu đãi
            arr.add(new Permission("Get all promotions", "/api/v1/promotions", "GET", "PROMOTIONS"));
            arr.add(new Permission("Get promotion by id", "/api/v1/promotions/{id}", "GET", "PROMOTIONS"));
            arr.add(new Permission("Create promotion", "/api/v1/promotions", "POST", "PROMOTIONS"));
            arr.add(new Permission("Update promotion", "/api/v1/promotions/{id}", "PUT", "PROMOTIONS"));
